...
class BlogPostModel(models.Model):
    ...
    main_img = models.ImageField(upload_to='blog-post-main-img/', verbose_name=_('main image'))
    banner = models.ImageField(upload_to='blog-post-main-img/', verbose_name=_('banner'))
